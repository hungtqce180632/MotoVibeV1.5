                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="${employee.status ? 'status-active' : 'status-inactive'}">
                                                <i class="fas ${employee.status ? 'fa-check-circle' : 'fa-times-circle'} me-1"></i>
                                        ...
                                        <td>
                                            <form action="customerList" method="POST">
                                                ...
                                                <button type="submit" class="btn ${employee.status ? 'btn-danger' : 'btn-success'} btn-sm">
                                                    <i class="fas ${employee.status ? 'fa-ban' : 'fa-check'} me-1"></i>
