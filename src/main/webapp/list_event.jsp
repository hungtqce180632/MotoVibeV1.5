<%-- Document : list_event Created on : Feb 23, 2025, 12:56:24 PM Author : Jackt --%>
                                    ...
                                    <div class="col">
                                        <div class="card h-100">
                                            ...
                                            <div class="card-content">
                                                ...
                                                <div class="card-meta">
                                                    <div class="date-info">
                                                        <div><i class="fas fa-calendar-day me-2"></i>Start:
                                                            ${event.date_start}</div>
                                                        <div><i class="fas fa-calendar-check me-2"></i>End:
                                                            ${event.date_end}</div>
                                                    </div>

                                                    <!-- Replace the existing form with this direct link -->
                                                    <a href="listevents?event_id=${event.event_id}"
