<%-- Document : manage_event Created on : Feb 28, 2025, 2:23:46 PM Author : ACER --%>
                    ...
                    <div class="event-management-container">
                        ...
                        <c:if test="${not empty sessionScope.statusMessage}">
                            <div class="alert alert-success">
                                <i class="fas fa-check-circle me-2"></i>${sessionScope.statusMessage}
                                ...
                                <tbody>
                                    <c:forEach var="event" items="${events}">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="EditEventServlet?id=${event.event_id}"
                                                        class="btn btn-warning btn-sm">
                                                        <i class="fas fa-edit me-1"></i> Edit
                                                    </a>
                                                    <a href="deleteEvent?id=${event.event_id}"
